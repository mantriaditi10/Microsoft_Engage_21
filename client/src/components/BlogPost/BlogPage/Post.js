...
import { bookmarkBlogPost } from '../../../actions/blogPosts'
...
const Post = (props) => {
    ...
    //setIsBookmarked(post.bookmarks.includes(user.result._id));
            ...
            <Card sx={{ display: "flex", boxShadow: 3 }}>
                <CardContent sx={{ flex: '1', ml: 2 }}>
                    ...
                    <Box sx={{ display: 'flex', alignItems: 'center', pb: 1 }}>
                        ...
                        <Button endIcon={<ThumbUpIcon/>} variant="outlined" sx={{ mr: 1 }} color="primary">Like</Button> 
                    </Box>
                </CardContent>
                <CardMedia
                    component="img"
